...
<head>
    <meta charset="UTF-8">
    <title>New Assessment Notification</title>
</head>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        <tr>
            <td style="background-color: #EE2D7B; padding: 20px 30px; color: #ffffff; border-top-left-radius: 8px; border-top-right-radius: 8px;">
                <h2 style="margin: 0; font-size: 24px;">📋 New Assessment Submitted</h2>
            </td>
        </tr>
        <tr>
            <td style="padding: 30px;">
                <p><strong>👤 Student Name:</strong> {{ $assessment->first_name }} {{ $assessment->last_name }}</p>
                <p><strong>📱 Phone:</strong> {{ $assessment->primary_phone }}</p>
                
                <p>Your assessment has been successfully submitted. Click the button below to view all details and access related documents easily.</p>

                <!-- Link -->
                <p><a href="http://localhost/cms/assessment/44/show" style="color: #EE2D7B; text-decoration: none;">Click here to Show a document</a></p>
            </td>
        </tr>
        <tr>
