        ...
        <div class="col-md-4 mb-5">
            <div class="card shadow-sm border-0 rounded-lg position-relative" style="background-color: #f8f9fa;">
                ...
                <div class="position-absolute top-0 end-0 p-2 d-flex gap-2">
                    ...
                    <form id="delete-employe-form-{{ $document->id }}" action="{{ route('service_documents.destroy', $document->id) }}" method="POST" style="display: none;">
                        @csrf
                        @method('DELETE')
                    </form>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('service_documents.update', $document->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf 
                        @method('PUT')
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content border-0 shadow-sm rounded-3">
            ...
            <div class="modal-body px-4 py-4">
                <form action="{{ route('service_documents.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<div class="modal fade" id="createMultiDocumentModal" tabindex="-1" aria-labelledby="createMultiDocumentModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="{{ route('service_documents.store.multi') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">
        <input type="hidden" name="service_id" value="{{ $service_id}}">
                    @error('service_id ')
